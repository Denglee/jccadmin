<template>
    <div class="headerTop-box">
        <div class="headerTop-user">
            <div class="clearfix">
                <div class="header-cityName ellipsis" @click="goIndex()">
                    <i class="el-icon-s-home"></i>管理系统
                </div>
            </div>
            ...
            <div class="header-rMain">
                ...
                <div class="headerTop-userInfo">
                    <!--<img class="userHeader" :src='logo' alt="">-->
            ...
            >
                ...
                <el-form-item>
                    <el-button
                            size="small"
                            class="btn-public"
                            @click="submitForm('changePassForm')"
                    >提交
                    </el-button
                    >
                    <el-button size="small" @click="resetForm('changePassForm')"
                    >重置
                    </el-button
                    >
                </el-form-item>
