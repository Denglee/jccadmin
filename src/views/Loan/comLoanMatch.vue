				...
				<el-form ref="form" :model="userChecked" label-width="180px">
					...
					<div class="compare-form">
						...
						<el-form-item label="申请贷款类型">
							<el-radio-group v-model="userChecked.loan_type" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.loan_type" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="贷款类型">
							<el-radio-group v-model="userChecked.loan_type_detail" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.loan_type_detail" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="最小年龄">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.min_age"
							          placeholder="例如：18"></el-input>
						</el-form-item>

						<el-form-item label="最大年龄">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.max_age"
							          placeholder="例如：60"></el-input>
						</el-form-item>

						<!-- 0503 多选demo-->
						<el-form-item label="婚姻状况">
							<el-checkbox-group v-model="checkedArr2.hyzk">
								<el-checkbox v-for="(item,index) in userInfo.hyzk" :key="index" :label="item.name"
								             name="item.id">
									{{item.value}}
								</el-checkbox>
							</el-checkbox-group>
						...
						<el-form-item label="职业类型">
							<el-radio-group v-model="userChecked.zylx" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.zylx" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="单位性质">
							<el-checkbox-group v-model="checkedArr2.dwxz" class="match-radioGropu">
								<el-checkbox v-for="(item,index) in userInfo.dwxz" :key="index" :label="item.name"
								             name="item.id">
									{{item.value}}
								</el-checkbox>
						...
						<el-form-item label="工资发放形式">
							...
							<el-checkbox-group v-model="checkedArr2.gzffxs" class="match-radioGropu">
								<el-checkbox v-for="(item,index) in userInfo.gzffxs" :key="index" :label="item.name"
								             name="item.id">
									{{item.value}}
								</el-checkbox>
						...
						<el-form-item label="平均工资">
							<el-radio-group v-model="userChecked.pjgz" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.pjgz" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="本单位工作时长">
							<el-radio-group v-model="userChecked.bdwgzsc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.bdwgzsc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="社保基数">
							<el-radio-group v-model="userChecked.sbjs" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sbjs" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="社保缴纳时长">
							<el-radio-group v-model="userChecked.sb_jnsc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sb_jnsc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="社保现单位缴纳时长">
							<el-radio-group v-model="userChecked.sb_xdwjnsc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sb_xdwjnsc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="公积金基数">
							<el-radio-group v-model="userChecked.gjjjs" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.gjjjs" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="公积金缴纳时长">
							<el-radio-group v-model="userChecked.gjj_jnsc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.gjj_jnsc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="公积金现单位缴纳时长">
							<el-radio-group v-model="userChecked.gjj_xdwjnsc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.gjj_xdwjnsc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="营业执照年限">
							<el-radio-group v-model="userChecked.yyzznx" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.yyzznx" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="单位是否考察">
							<el-radio-group v-model="userChecked.dwsfkc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.dwsfkc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="对公流水">
							<el-radio-group v-model="userChecked.dgls" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.dgls" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="公司开票金额">
							<el-radio-group v-model="userChecked.gskpje" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.gskpje" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="是否有上市企业订单">
							<el-radio-group v-model="userChecked.sfyssqydd" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sfyssqydd" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="是否高新技术企业">
							<el-radio-group v-model="userChecked.sfgxjsqy" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sfgxjsqy" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="公司纳税金额">
							<el-radio-group v-model="userChecked.gsnsje" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.gsnsje" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
					...
					<div class="compare-form">
						...
						<el-form-item label="按揭中（月供时间）">
							<el-radio-group v-model="userChecked.ajz" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.ajz" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="按揭结清（结清时间）">
							<el-radio-group v-model="userChecked.ajjq" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.ajjq" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="全款房（过户时间）">
							<el-radio-group v-model="userChecked.qkf" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.qkf" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>

						<el-form-item label="最小房龄" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.min_fl"
							          placeholder="例如：2"></el-input>
						</el-form-item>

						<el-form-item label="最大房龄" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.max_fl"
							          placeholder="例如：60"></el-input>
						</el-form-item>
					</div>
					...
					<div class="compare-form">
						<el-form-item label="按揭车（按揭时间）">
							<el-radio-group v-model="userChecked.ajc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.ajc" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="全款车（按揭结清或过户时间）">
							<el-radio-group v-model="userChecked.qkc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.qkc" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="车辆所有权">
							<el-radio-group v-model="userChecked.clsyc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.clsyc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="车辆性质">
							<el-radio-group v-model="userChecked.clxz" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.clxz" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="车辆持证时间">
							<el-radio-group v-model="userChecked.clczsj" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.clczsj" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="车辆归属地">
							<el-radio-group v-model="userChecked.clgsd" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.clgsd" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="车龄">
							<el-radio-group v-model="userChecked.cl" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.cl" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="交强险剩余有效期">
							<el-radio-group v-model="userChecked.jqxsyyxq" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.jqxsyyxq" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="行驶公里数">
							<el-radio-group v-model="userChecked.xsgls" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.xsgls" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="商业险剩余有效期">
							<el-radio-group v-model="userChecked.syxsyyxq" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.syxsyyxq" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="保险类型">
							<el-radio-group v-model="userChecked.bxlx" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.bxlx" :key="index" :label="item.name">{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="保险缴纳方式">
							<el-radio-group v-model="userChecked.bxjnfs" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.bxjnfs" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="保险缴费时间">
							<el-radio-group v-model="userChecked.bxjfsj" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.bxjfsj" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
					...
					<div class="compare-form">
						<el-form-item label="一个月内查询次数" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.ygyncxcs"
							          placeholder="例如：1"></el-input>
						</el-form-item>

						<el-form-item label="两个月内查询次数" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.lgyncxcs"
							          placeholder="例如：1"></el-input>
						</el-form-item>

						<el-form-item label="三个月内查询次数" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.sgyncxcs"
							          placeholder="例如：1"></el-input>
						</el-form-item>

						<el-form-item label="六个月内查询次数" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.liugyncxcs"
							          placeholder="例如：1"></el-input>
						</el-form-item>

						<el-form-item label="十二个月内查询次数" class="width-inlineLabel">
							<el-input type="number" @mousewheel.native.prevent clearable v-model="userChecked.segyncxcs"
							          placeholder="例如：1"></el-input>
						</el-form-item>

						<el-form-item label="当前小额笔数">
							<el-radio-group v-model="userChecked.dqxebs" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.dqxebs" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="当前消费金融笔数">
							<el-radio-group v-model="userChecked.dqxfjrbs" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.dqxfjrbs" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="贷款/信用卡是否存在止付；呆账；关注等异常">
							<el-radio-group v-model="userChecked.sfczyc" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sfczyc" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<el-form-item label="当前逾期额度">
							<el-radio-group v-model="userChecked.dqyqed" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.dqyqed" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
						...
						<div>
							<el-form-item label="近半年内有无逾期">
								<el-radio-group v-model="userChecked.bnn_wyq" class="match-radioGropu">
									<el-radio v-for="(item,index) in userInfo.bnn_wyq" :key="index" :label="item.name">
										{{item.value}}
									</el-radio>
								</el-radio-group>
							</el-form-item>
							<div v-if="userChecked.bnn_wyq == 1">
								<el-form-item label="逾期一个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.bnn_yqygycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期两个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.bnn_yqlgycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期三个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.bnn_yqsgycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期四个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.bnn_yqsigycs" placeholder="例如：1"></el-input>
								</el-form-item>
							</div>
						</div>
						...
						<div>
							<el-form-item label="近一年内有无逾期">
								<el-radio-group v-model="userChecked.ynn_wyq" class="match-radioGropu">
									<el-radio v-for="(item,index) in userInfo.ynn_wyq" :key="index" :label="item.name">
										{{item.value}}
									</el-radio>
								</el-radio-group>
							</el-form-item>
							<div v-if="userChecked.ynn_wyq == 1">
								<el-form-item label="逾期一个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.ynn_yqygycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期两个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.ynn_yqlgycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期三个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.ynn_yqsgycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期四个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.ynn_yqsigycs" placeholder="例如：1"></el-input>
								</el-form-item>
							</div>
						</div>
						...
						<div>
							<el-form-item label="近两年内有无逾期">
								<el-radio-group v-model="userChecked.lnn_wyq" class="match-radioGropu">
									<el-radio v-for="(item,index) in userInfo.lnn_wyq" :key="index" :label="item.name">
										{{item.value}}
									</el-radio>
								</el-radio-group>
							</el-form-item>
							<div v-if="userChecked.lnn_wyq == 1">
								<el-form-item label="逾期一个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.lnn_yqygycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期两个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.lnn_yqlgycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期三个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.lnn_yqsgycs" placeholder="例如：1"></el-input>
								</el-form-item>
								<el-form-item label="逾期四个月次数" class="width-inlineLabel">
									<el-input type="number" @mousewheel.native.prevent clearable
									          v-model="userChecked.lnn_yqsigycs" placeholder="例如：1"></el-input>
								</el-form-item>
							</div>
						</div>
					</div>
					...
					<div class="compare-form">
						<el-form-item label="是否使用过微粒贷">
							<el-radio-group v-model="userChecked.sfsygwld" class="match-radioGropu">
								<el-radio v-for="(item,index) in userInfo.sfsygwld" :key="index" :label="item.name">
									{{item.value}}
								</el-radio>
							</el-radio-group>
						</el-form-item>
