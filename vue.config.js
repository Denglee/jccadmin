...
module.exports = {
  ...
  configureWebpack: {
    ...
    output: { // 输出重构  打包编译后的 文件名称  【模块名称.版本号.时间戳】
      ...
      filename: `admin/js/[name].${Timestamp}.js`,
      chunkFilename: `admin/js/[name].${Timestamp}.js`,
    },
  },
...
<<<<<<< HEAD
        // target: "http://5mg6it.natappfree.cc",// 测试答咔访问的接口域名
=======
>>>>>>> cd31e90a390f573e5c59eb7634e50667d2ea07ec
